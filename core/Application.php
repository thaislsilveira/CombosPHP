...
class Application
{
    ...
    const APP_NAME = 'Combos';
        
    //..ícone da aplicação.
    const APP_ICON = 'core/img/combos.png';
    ...
    //..config de email.
    const EMAIL = 'seu email'; //..email usado para enviar as msgs
    const EMAIL_NAME = 'Combos 2018'; //..nome que aparecerá ao destinatário
    const EMAIL_PASSWD = 'senha do email'; //..senha do e-mail
    ...
    {
        $rootPath = $_SERVER['DOCUMENT_ROOT'] . 'Combos2018/' ;        
        return $rootPath;
    }
